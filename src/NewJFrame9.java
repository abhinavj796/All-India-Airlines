 ...
 * NewJFrame9.java
 *
 * Created on Oct 26, 2013, 9:20:20 AM
 */
...
public class NewJFrame9 extends javax.swing.JFrame {
   ...
   Connection con=null;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("ADD NEW PLANE'"));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {            Class.forName("java.sql.Driver");
          ...
          st.executeUpdate("insert into flight values("+(a)+",'"+(b)+"','"+(t)+"');");
            rs.close();
                st.close();
            con.close();
